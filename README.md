...
- [vite-plugin-sri4](https://github.com/7a6163/vite-plugin-sri4) - Generates Subresource Integrity hashes for build assets and injects `integrity` attributes into HTML.
